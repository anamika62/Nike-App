...
const Hero = () => {
  ...
  return (
    <section
      // corner border red
      id="home"
      className='w-full flex lg:flex-row flex-col justify-center min-h-screen gap-10 max-container border-red-500'>
      ...
      <div className='relative flex-1 flex justify-center items-center xl:min-h-screen max-xl:py-40 bg-gray-200 bg-hero bg-left '>
        <img
          src={bigShoeImg}
          alt='shoe nay colletion'
          width={610}
          height={502}
